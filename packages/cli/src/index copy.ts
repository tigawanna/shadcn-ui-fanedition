...
async function main() {
  ...
  program
    ...
    .action(async (options) => {
      logger.warn('This command assumes a Next.js project with TypeScript and Tailwind CSS.');
      logger.warn(
  ...
  program
    ...
    .action(async (components: string[], options) => {
      ...
      let selectedComponents = availableComponents.filter((component) => {
        ...
        return components.includes(component.component);
      });
      ...
      for (const component of selectedComponents) {
        ...
        for (const file of component.files) {
          ...
          file.content = file.content.replace('@/lib/utils', `${root_alias}/lib/utils`);
          file.content = file.content.replace('@/components/ui/', `${root_alias}/components/ui/`);
